    ...
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="flex-1 bg-black/40 p-6 rounded-2xl border border-purple-700 shadow-lg">
        ...
        <div className="text-lg space-y-1">
          ...
          <p>Range: {car.range}</p>
          <p>
            Year: <span className="text-red-500">{car.year}</span>
          </p>
        </div>
        <Link
          to=".."
      ...
      <div className="flex-1 bg-black/30 p-6 rounded-2xl border border-purple-600 shadow-lg">
        ...
        <ul className="text-gray-300 space-y-2">
          ...
          <li>
            Cars Description:{" "}
            <span className="font-semibold">{car.description1}</span>
          </li>
          <li>
            Cars Brand: <span className="text-red-500">{car.brand}</span>
          </li>
          <li>
            Cars Model: <span className="text-red-500">{car.model}</span>
          </li>
